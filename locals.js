...
I18N.zh = {
    ...
    "pubilc": { // 公共區域翻譯
        "static": { // 靜態翻譯
            ...
            ", or pasting from the clipboard.": "，或複製粘貼內容。",
    ...
    "page-dashboard": { // 已登錄的首頁
        "static": { // 靜態翻譯
            // 新手幫助
            "Learn Git and GitHub without any code!": "瞭解 Git 和 GitHub 無需任何代碼！",
    ...
    "page-profile": { // 個人首頁
        "static": { // 靜態翻譯
            "Updating your profile with your name, location, and a profile picture helps other GitHub users get to know you.": "更新您的資料信息包括姓名，地址，頭像等資料，讓其他用戶更容易的瞭解您。",
            ...
            "Contribution activity": "貢獻信息",

            "You can now pin up to 6 repositories.": "你現在可以設置6個固定倉庫。",
        ...
        "regexp": [ // 正則翻譯
            [/Created (\d+)[\s\r\n]+commits? in[\s\r\n]+(\d+)[\s\r\n]+repositor(y|ies)/, "在 $2 個庫中創建了 $1 次提交"],
            [/Created (\d+)[\s\r\n]+repositor(y|ies)/, "創建了 $1 個倉庫"],
    ...
    "page-account": { // 個人設置
        "static": { // 靜態翻譯
            ...
            "Company": "公司",
            "You can": "您可以",
            "other users and organizations to link to them.": "其他用戶和組織鏈接到他們。",
            "Location": "地址",
            ...
            "will be used for account-related notifications (e.g. account changes and billing receipts) as well as any web-based GitHub operations (e.g. edits and merges).": "將被用於接收相關通知 (例如：賬單信息)，以及任何基於 web 的 GitHub 操作 (例如：編輯或合併操作)。",
            "Primary": "主帳戶",
            "Private": "私有",
            "Public": "公開",
            ...
            "We will use": "我們將使用",
            "when performing web-based Git operations and sending email on your behalf. If you want command line Git operations to use your private email you must": "作為默認\"發件人\"地址以您的名義發送電子郵件。如果您想在命令行 Git 的操作中使用您的私人郵件地址，您必須在",
            ...
            "Looking for activity notification controls? Check the": "想要瞭解更詳細的通知設置，請前往",
            ...
            "Revoke all": "註銷全部",
            "You have granted the following applications access to your account. Read more about connecting with third-party applications at": "您已授權下來應用訪問您的帳戶信息，如需瞭解更多請閱讀",
            "Sort": "排序",
            "Sort by": "排序方式",
            "Alphabetical": "字母排序",
            "Recently used": "最近使用",
    ...
    "vis-public": { // 倉庫頁
        "static": { // 靜態翻譯
            ...
            "Attach files by dragging & dropping,": "拖拽添加附件，",
            "selecting them": "或選擇文件，",
            ", or pasting from the clipboard.": "或複製黏貼內容。",
            ...
            "Learn more about pull requests.": "瞭解更多拉取請求。",
            ...
            "Choose two branches to see what』s changed or to start a new pull request. If you need to, you can also": "選擇兩個分支，看看發生了什麼改變，或發起一個新的拉請求。如果你需要，你也可以",
            "base fork:": "基派生:",
            ...
            "GitHub Issues adds lightweight issue tracking tightly integrated with your repository. Add issues to milestones, label issues, and close & reference issues from commit messages.": "GitHub 與您的存儲庫添加輕量級問題跟蹤緊密集成的問題。添加里程碑的問題，標籤問題，並密切與參考問題提交消息。",
            ...
            "Source": "源",
            "Your GitHub Pages site is currently being built from the": "你的 GitHub Pages 網站目前正在建立在",
            "branch.": "分支。",
            "Select source": "選擇源",
            "Use the": "使用",
            ...
            "Custom domain": "自定義域名",
            "Custom domains allow you to serve your site from a domain other than": "自定義域名也許你用其他域名訪問",
            ...
            "Replace your existing site by using our automatic page generator. Author your content in our Markdown editor, select a theme, then publish.": "通過使用我們的自動頁面生成器替換現有的網站。您可以在我們的 Markdown 編輯器，選擇一個主題，然後發佈。",
            "Launch automatic page generator": "啟動自動生成器",
            "Enforce HTTPS": "強制 HTTPS",
            "— Unavailable for your site because you have a custom domain configured (": "- 無法為您的網站開啟，因為您配置了一個自定義域名 (",
            ...
            "When HTTPS is enforced, your site will only be served over HTTPS.": "當開啟強制 HTTPS 後，您的網站將只能通過 HTTPS 訪問。",
            ...
            "Create a new release": "創建一個發佈",
            "Releases are powered by": "發佈是通過在倉庫中標記",
            "tagging specific points of history": "特定歷史版本",
            "in a repository. They』re great for marking release points like": "，用於發佈的版本類似",
            ...
            "Draft a new release": "起草新版本發佈",
            "Add release notes": "添加發佈說明",
            "Edit release notes": "編輯發佈說明",
            "(No release notes)": "(沒有發佈說明)",
            "Release notes": "發佈說明",
            ...
            "This is a pre-release": "這是一個預發佈版本",
            "We』ll point out that this release is identified as non-production ready.": "我們會指定該版本為未正式發佈。",
            "Update release": "更新發佈",
            "Publish release": "發佈版本",
            "Save draft": "保存草稿",
            "Saved!": "已保存",
        ...
        "regexp": [ // 正則翻譯
            ...
            [/([\d,]+) commits?/, "$1 次提交"],
            [/to ([^\n]+)[\n\s]+since this release/, "到 $1 分支在此發佈中。"],
            [/· ([\d,]+) comments?/, "$1 次提交"]
        ],
    },
    ...
    "homepage": { // 未登錄首頁
        "static": { // 靜態翻譯
            ...
            "Millions of developers use GitHub to build personal projects, support their businesses, and work together on open source technologies.": "數以百萬計的開發人員使用 GitHub 建立個人項目，支持他們的企業，共同在開放源碼技術。",
            ...
            "Individuals": "個人",
            "Use GitHub to create a personal project, whether you want to experiment with a new programming language or host your life』s work.": "使用 GitHub 來創建一個個人項目，不管您想要嘗試一個新的編程語言或主機在您生活及工作。",
            "Communities": "社區",
    ...
    "notifications": { // 通知頁面
        "static": { // 靜態翻譯
            ...
            "Are you sure?": "您確定嗎？",
            "Are you sure you want to mark all unread notifications as read?": "你確定要將所有的未讀通知標記為已讀？",
    ...
    "trending": { // 趨勢頁面
        "static": { // 靜態翻譯
            ...
            "These are the organizations and developers building the hot tools this week.": "這是本周創建熱門項目的組織和開發人員。",
        ...
        "regexp": [ // 正則翻譯
            ...
            [/([\d,]+) stars this week([^B]+)[\w ]+/, "本周 $1 贊$2創建者"],
